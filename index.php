...
<div class="hero mt-5 pt-4 container">
    <div class="row w-100 align-items-center">
        ...
        <div class="col-lg-6 text-center text-lg-start z-1" data-aos="fade-right" data-aos-duration="1000">
            ...
            <img src="assets/images/logo.png" alt="Cyberhut Logo" class="mb-4 d-block d-lg-none mx-auto" style="width: 80px; height: 80px; filter: drop-shadow(0 0 20px rgba(6,182,212,0.6)); border-radius: 20%;">
